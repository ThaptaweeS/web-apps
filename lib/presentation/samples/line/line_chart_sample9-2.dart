...
class LineChartSample92 extends StatefulWidget {
  LineChartSample92({
    super.key,
  ...
  @override
  State<LineChartSample92> createState() => _LineChartSample92State();
}

class _LineChartSample92State extends State<LineChartSample92> {
...
class LineChartSample93 extends StatefulWidget {
  LineChartSample93({
    super.key,
    required this.historyChartData2,
    required int crossAxisCount,
    required num childAspectRatio,
  });
  List<HistoryChartModel2> historyChartData2;
  @override
  State<LineChartSample93> createState() => _LineChartSample93State();
}

class _LineChartSample93State extends State<LineChartSample93> {
  List<Color> gradientColors = [
    Color.fromARGB(255, 104, 112, 218),
    Color.fromARGB(255, 104, 112, 218),
  ];
  ...
  LineChartData mainData() {
    return LineChartData(
      ...
      titlesData: FlTitlesData(
        ...
        bottomTitles: AxisTitles(
          sideTitles: SideTitles(
            ...
            getTitlesWidget: (value, titleMeta) {
              if (value.toInt() >= 0 &&
                  value.toInt() < widget.historyChartData2.length) {
                return Padding(
                  padding: EdgeInsets.only(
                    top: 5,
                    left: 20,
                  ...
                  child: Transform.rotate(
                    angle: -45,
                    child: Text(
                      widget.historyChartData2[value.toInt()].samplingDate,
                      style: TextStyle(fontSize: 10),
                      textDirection: TextDirection.rtl,
                      textAlign: TextAlign.center,
                    ),
      ...
      lineBarsData: [
        LineChartBarData(
          spots: ((() {
            if (widget.historyChartData2.length == 1 &&
                double.parse(
                        ConverstStr(widget.historyChartData2[0].resultApprove)) >
                    0) {
              //for (int i = 0; i < historyChartData.length; i++)
              print("addddddd");
              return [
              ...
              List<FlSpot> buff = [];
              for (int i = 0; i < widget.historyChartData2.length; i++) {
                buff.add(FlSpot(
                    i.toDouble(),
                    (double.parse(ConverstStr(
                        widget.historyChartData2[i].resultApprove)))));
              }
              return buff;
            }
          }())),
            ...
            getTitlesWidget: (value, titleMeta) {
              return Padding(
                ...
                child: Transform.rotate(
                  angle: -45,
                  child: Text(
                    widget.historyChartData2[value.toInt()].date,
/*                   style: TextStyle(color: Colors.red), */
                    style: TextStyle(fontSize: 14),
                    textDirection: TextDirection.rtl,
                    textAlign: TextAlign.center,
...
String ConverstStr2(dynamic input) {
  if (isNumeric2(input)) {
    return input;
  } else {
    return '0';
...
List<HistoryChartModel3> HistoryChartModel3FromJson(String str) =>
    List<HistoryChartModel3>.from(
        json.decode(str).map((x) => HistoryChartModel3.fromJson(x)));

String HistoryChartModel3ToJson(List<HistoryChartModel3> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class HistoryChartModel3 {
  HistoryChartModel3({
    this.id,
    this.custFull,
    this.sampleName,
  ...
  factory HistoryChartModel3.fromJson(Map<String, dynamic> json) =>
      HistoryChartModel3(
        id: json["id"] ?? "",
        custFull: json["CustFull"] ?? "",
        sampleName: json["SampleName"] ?? "",
