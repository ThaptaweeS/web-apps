...
class LineChartSample95 extends StatefulWidget {
  LineChartSample95({
    super.key,
  ...
  @override
  State<LineChartSample95> createState() => _LineChartSample95State();
}

class _LineChartSample95State extends State<LineChartSample95> {
