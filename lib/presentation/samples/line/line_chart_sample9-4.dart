...
class LineChartSample94 extends StatefulWidget {
  LineChartSample94({
    super.key,
  ...
  @override
  State<LineChartSample94> createState() => _LineChartSample94State();
}

class _LineChartSample94State extends State<LineChartSample94> {
