            ...
            child: Table(
              ...
              children: [
                buildTableRow(
                  ...
                  Tank219AfterPage(),
                  context,
                  "http://127.0.0.1:1111/tank2before19",
                  "http://127.0.0.1:1111/tank2after19",
                ),
                // buildTableRow(
                ...
                //   Tank3AfterPage(),
                //   context,
                //   "http://127.0.0.1:1111/tank3before19",
                //   "http://127.0.0.1:1111/tank3after19",
                // ),
                buildTableRow(
                  ...
                  Tank519AfterPage(),
                  context,
                  "http://127.0.0.1:1111/tank5before19",
                  "http://127.0.0.1:1111/tank5after19",
                ),
                // buildTableRow(
                ...
                //   BlankPage(),
                //   context,
                //   "http://127.0.0.1:1111/tank4before19",
                //   "http://127.0.0.1:1111/tank4after19",
                // ),
                // buildTableRow(
                ...
                //   BlankPage(),
                //   context,
                //   "http://127.0.0.1:1111/tank6before19",
                //   "http://127.0.0.1:1111/tank6after19",
                // ),
                // buildTableRow(
                ...
                //   BlankPage(),
                //   context,
                //   "http://127.0.0.1:1111/tank7before19",
                //   "http://127.0.0.1:1111/tank7after19",
                // ),
                buildTableRow(
                  ...
                  Tank819AfterPage(),
                  context,
                  "http://127.0.0.1:1111/tank8before19",
                  "http://127.0.0.1:1111/tank8after19",
                ),
                buildTableRow(
                  "Tank9 : Phosphate",
                  Icons.add_chart_outlined,
                  ...
                  Tank919AfterPage(),
                  context,
                  "http://127.0.0.1:1111/tank9before19",
                  "http://127.0.0.1:1111/tank9after19",
                ),
                buildTableRow(
                  "Tank10 : Phosphate",
                  Icons.add_chart_outlined,
                  ...
                  Tank1019AfterPage(),
                  context,
                  "http://127.0.0.1:1111/tank10before19",
                  "http://127.0.0.1:1111/tank10after19",
                ),
                // buildTableRow(
                ...
                //   BlankPage(),
                //   context,
                //   "http://127.0.0.1:1111/tank11before19",
                //   "http://127.0.0.1:1111/tank11after19",
                // ),
                // buildTableRow(
                //   "Tank12 : Hot D.I.",
                //   Icons.add_chart_outlined,
                ...
                //   BlankPage(),
                //   context,
                //   "http://127.0.0.1:1111/tank12before19",
                //   "http://127.0.0.1:1111/tank12after19",
                // ),
                buildTableRow(
                  "Tank13 : Lubricant",
                  Icons.add_chart_outlined,
                  ...
                  Tank1319AfterPage(),
                  context,
                  "http://127.0.0.1:1111/tank13before19",
                  "http://127.0.0.1:1111/tank13after19",
                ),
                buildTableRow(
                  "Tank14 : Lubricant",
                  Icons.add_chart_outlined,
                  ...
                  Tank1419AfterPage(),
                  context,
                  "http://127.0.0.1:1111/tank14before19",
                  "http://127.0.0.1:1111/tank14after19",
                ),
              ],
            ),
          ),
