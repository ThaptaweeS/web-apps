...
class _Tank919BeforePageState extends State<Tank919BeforePage> {
  ...
  void fetchRoundValue() async {
    try {
      final response = await http
          .post(Uri.parse('http://127.0.0.1:1111/tank9beforecheck19'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tank9 : Phosphate | 19:00 (Before)'),
      ),
      body: Center(
        child: Padding(
  ...
  void saveValuesToAPI(BuildContext context) async {
    final url = 'http://127.0.0.1:1111/t919b';
  ...
  void fetchDataFromAPI() async {
    final url = 'http://127.0.0.1:1111/tank9beforedata19';
